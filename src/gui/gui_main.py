...
class MainWindow(QMainWindow):
    ...
    def _create_main_widget(self):
        ...
        self.worker.signals.run_completed.connect(self.plot_historic)
        bot_selector_label = QLabel("Bot")
        self.bot_selector = QComboBox()
        self.bot_selector.addItems([BOT_HELLO, BOT_INTUITION])
        main_layout.addWidget(self.candles_historic_plot, 0, 0, 1, 3)
